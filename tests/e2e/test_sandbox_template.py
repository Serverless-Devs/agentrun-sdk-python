...
class TestSandboxTemplate:
    ...
    def test_create_template(self, template_name: str):
        """测试创建 Template - Code Interpreter 类型"""
    ...
    def test_create_browser_template(self, template_name: str):
        """测试创建 Template - Browser 类型"""
        browser_template_name = f"{template_name}-browser"
    ...
    def test_create_duplicate_template(self, template_name: str):
        """测试创建重复 Template 会抛出异常"""
        # 第一次创建
        template = Template.create(
            TemplateInput(
    ...
    def test_get_template(self, template_name: str):
        """测试获取 Template"""
        # 先创建 Template
    ...
    def test_list_templates(self, template_name: str):
        """测试列举 Templates"""
        # 创建测试 Template
        template = Template.create(
            TemplateInput(
    ...
    def test_list_templates_by_type(self, template_name: str):
        """测试按类型过滤列举 Templates"""
        # 创建 Code Interpreter Template
        template = Template.create(
            TemplateInput(
    ...
    def test_update_template(self, template_name: str):
        """测试更新 Template"""
        try:
            time1 = datetime.datetime.now(datetime.timezone.utc)
            ...
            # 更新 Template
            new_description = f"更新后的描述 - {time.time()}"
            updated_template = Template.update_by_name(
                template_name=template_name,
                input=TemplateInput(
                    template_type=TemplateType.CODE_INTERPRETER,
                    description=new_description,
    ...
    def test_delete_template(self, template_name: str):
        """测试删除 Template"""
        # 创建 Template
        template = Template.create(
            TemplateInput(
    ...
    def test_template_lifecycle(self, template_name: str):
        """测试 Template 的完整生命周期"""
        # 1. 创建
        template = Template.create(
            TemplateInput(
    ...
    def test_template_via_sandbox_class(self, template_name: str):
        """测试通过 Sandbox 类操作 Template"""
        # 通过 Sandbox 类创建 Template
        ...
        try:
            ...
            # 通过 Sandbox 类删除 Template
            Sandbox.delete_template(template_name=template_name)
    ...
    def test_template_validation_code_interpreter_network(
        self, template_name: str
    ):
        """测试 Code Interpreter 类型 Template 的网络模式验证"""
        # Code Interpreter 类型不能使用 PRIVATE 网络模式
    ...
    def test_concurrent_template_operations(self, template_name: str):
        ...
        try:
            ...
            # 并发删除所有 Templates
            for name in template_names:
                Template.delete_by_name(template_name=name)
